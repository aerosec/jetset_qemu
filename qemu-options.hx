...
DEFHEADING(CortexM options:)
STEXI
@table @option
ETEXI

DEF("initial_sp", HAS_ARG, QEMU_OPTION_initial_sp, \
    "-initial_sp sp Initial PC for cortex m-3 or cortex m-4 machine\n", QEMU_ARCH_ARM)

DEF("initial_pc", HAS_ARG, QEMU_OPTION_initial_pc, \
    "-initial_pc pc Initial PC for cortex m-3 or cortex m-4 machine\n",  QEMU_ARCH_ARM)
    
DEF("use_robot_dma", HAS_ARG, QEMU_OPTION_use_robot_dma, \
    "-initial_pc use_dma use robot_dma\n",  QEMU_ARCH_ARM)
...
DEF("concrete_target", HAS_ARG, QEMU_OPTION_concrete_target, \
    "-concrete_target name Concrete target name\n", QEMU_ARCH_ALL)
