...
static void sam3x8e_init(MachineState *machine)
{
    DeviceState *dev;
    MemoryRegion *sram1;
    MemoryRegion *sram3;
    ...
    {
        synth_dev = qdev_create(NULL, "synth_sam3x8e");
    }
...
static void sam3x8e_machine_init(MachineClass *mc)
{
    mc->desc = "SAM3x8e Family of Machines";
    mc->init = sam3x8e_init;
    mc->ignore_memory_transaction_failures = true;
}

DEFINE_MACHINE("sam3x8e", sam3x8e_machine_init)
